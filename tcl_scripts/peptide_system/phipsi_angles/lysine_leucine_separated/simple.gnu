...
set output "lysine_phipsi_k2l6.png"
...
set title "Temperature 300- (K2L6) Sec. St. phipsi plot LYSINE" font 'Helvetica Bold,56'
set xrange [0:1000]
set yrange [0:1]
##set tics scale 2.5
set ytics 0.1
...
##set key at 110,0.95
set key font ',52'
pl 'lysine_average_1.dat' u 2:3 title "RUN1" w l lw 8 lc rgb 'red' \
, 'lysine_average_2.dat' u 2:3 title "RUN2" w l lw 8 lc rgb 'green' \
, 'lysine_average_3.dat' u 2:3 title "RUN3" w l lw 8 lc rgb 'blue' \
, 'lysine_average_4.dat' u 2:3 title "RUN4" w l lw 8 lc rgb 'magenta'