...
set title "Temperature 300- (K2L6) Sec. St. phipsi plot" font 'Helvetica Bold,56'
set xrange [0:1000]
set yrange [0:1]
##set tics scale 2.5
set ytics 0.1
...
##set key at 110,0.95
set key font ',52'
pl 'dihedralsaverage_1.dat' u 2:3 title "RUN1" w l lw 8 lc rgb 'red' \
, 'dihedralsaverage_2.dat' u 2:3 title "RUN2" w l lw 8 lc rgb 'green' \
, 'dihedralsaverage_3.dat' u 2:3 title "RUN3" w l lw 8 lc rgb 'blue' \
, 'dihedralsaverage_4.dat' u 2:3 title "RUN4" w l lw 8 lc rgb 'magenta'
