...
set output "average_dihedrals_k2l6.png"
...
##set key at 110,0.95
set key font ',52'
pl 'all_average_dihedral_k2l6.dat' u 1:2 title "Total" w l lw 8 lc rgb 'red' \
, 'all_average_lysine_k2l6.dat' u 1:2 title "Lysine" w l lw 8 lc rgb 'green' \
, 'all_average_leucine_k2l6.dat' u 1:2 title "Leucine" w l lw 8 lc rgb 'blue'